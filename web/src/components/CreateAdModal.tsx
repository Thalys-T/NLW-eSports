...
export function CreateAdModal() {
  ...
  return (<Dialog.Portal>
    ...
    <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black">
      <Dialog.Title className="text-3xl text-white font-black ">Pubique um Anúncio</Dialog.Title>
      ...
      <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <select
            ...
            defaultValue="holder"
          >
            <option disabled value="holder">Selecione o game que deseja jogar</option>
            {games.map(game => {
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder="Tudo bem ser ZERO" min={0} max={99} />
          </div>
          <div className="flex flex-col gap-2">
